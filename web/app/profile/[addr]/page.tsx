  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {[
          { label: 'Matches', value: '47', color: '#3B82F6' },
          { label: 'Win Rate', value: '64%', color: '#10B981' },
          { label: 'Xtreme Finishes', value: '8', color: '#A855F7' },
          { label: 'Burst Finishes', value: '15', color: '#F97316' },
        ].map((stat) => (
      ...
      <div>
        <h2 className="mb-4 text-lg font-bold text-white">Spirit Beast Collection</h2>
